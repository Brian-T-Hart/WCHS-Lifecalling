...
class MBTI extends Component {
    ...
    //     console.log('myStrengths from Dashboard ', this.props.myMBTI);
    // }

    // componentDidUpdate() {
    //     console.log('MyStrengths updated!');
    //     console.log('myStrengths componentDidMount ', this.props.myMBTI);
    // }

    // constructor(props) {
    //     super(props);
    //     this.state = {
    //         strengths: this.props.MBTI,
    //         myStrengths: this.props.myMBTI
    //     }
                ...
                <div className="infoTitle row">
                    <div className="col-md-12">
                        <h3>MBTI
                            ...
                            <span data-toggle="modal" data-target="#strengthsModal"><img id="editIcon" src="./../images/editIcon.png" alt="" /></span></h3>
                    </div>
                </div>
